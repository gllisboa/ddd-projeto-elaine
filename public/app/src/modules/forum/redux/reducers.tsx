...
export default function forum (state: ForumState = states,
  ...
  switch (action.type as actions.ForumActionType) {
    ...
    case actions.GETTING_POPULAR_POSTS_FAILURE:
      ...
      case actions.GETTING_UNPOPULAR_POSTS:
        return {
          ...state,
          ...ReduxUtils.reportEventStatus("isGettingUnpopularPosts"),
          error: ''
        };
      case actions.GETTING_UNPOPULAR_POSTS_SUCCESS:
        return {
          ...state,
          ...ReduxUtils.reportEventStatus("isGettingUnpopularPosts", true),
          unpopularPosts: action.posts,
        };
      case actions.GETTING_UNPOPULAR_POSTS_FAILURE:
        return {
          ...state,
          ...ReduxUtils.reportEventStatus("isGettingUnpopularPosts", false),
          error: action.error
        };
    ...
    case actions.GETTING_COMMENT_BY_COMMENT_ID_FAILURE:
      ...
      case actions.GETTING_AVERAGE_COMMENT:
        return {
          ...state,
          ...ReduxUtils.reportEventStatus("isGettingAverageComment"),
          error: ''
        };

      case actions.GETTING_AVERAGE_COMMENT_SUCCESS:
        return {
          ...state,
          ...ReduxUtils.reportEventStatus("isGettingAverageComment", true),
          averageComment: action.averageComment,
        };

      case actions.GETTING_AVERAGE_COMMENT_FAILURE:
        return {
          ...state,
          ...ReduxUtils.reportEventStatus("isGettingAverageComment", false),
          error: action.error
        };
