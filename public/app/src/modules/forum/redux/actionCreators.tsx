...
function getUnpopularPosts (): ForumAction {
  return {
    type: actions.GETTING_UNPOPULAR_POSTS
  };
}
...
function getUnpopularPostsSuccess (posts: Post[]): ForumAction {
  return {
    type: actions.GETTING_UNPOPULAR_POSTS_SUCCESS,
    posts
  };
}
...
function getUnpopularPostsFailure (error: string): ForumAction & { error: string } {
  return {
    type: actions.GETTING_UNPOPULAR_POSTS_FAILURE,
    error
  };
}
...
function gettingAverageComment (): ForumAction {
  return {
    type: actions.GETTING_AVERAGE_COMMENT
  }
}

function gettingAverageCommentSuccess (averageComment: number): ForumAction {
  return {
    type: actions.GETTING_AVERAGE_COMMENT_SUCCESS,
    averageComment
  }
}

function gettingAverageCommentFailure (error: string): ForumAction {
  return {
    type: actions.GETTING_AVERAGE_COMMENT_FAILURE,
    error
  }
}
...
export {
  ...
  getUnpopularPosts,
  getUnpopularPostsSuccess,
  getUnpopularPostsFailure,

  gettingCommentByCommentId,
  gettingCommentByCommentIdSuccess,
  gettingCommentByCommentIdFailure,

  gettingAverageComment,
  gettingAverageCommentSuccess,
  gettingAverageCommentFailure,
