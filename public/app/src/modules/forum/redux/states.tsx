...
export interface ForumState {
  ...
  isGettingUnpopularPosts: boolean;
  isGettingUnpopularPostsSuccess: boolean;
  isGettingUnpopularPostsFailure: boolean;

  isGettingCommentByCommentId: boolean;
  isGettingCommentByCommentIdSuccess: boolean;
  isGettingCommentByCommentIdFailure: boolean;

  isGettingAverageComment: boolean;
  isGettingAverageCommentSuccess: boolean;
  isGettingAverageCommentFailure: boolean;
...
const initialForumState: ForumState = {
  ...
  isGettingUnpopularPosts: false,
  isGettingUnpopularPostsSuccess: false,
  isGettingUnpopularPostsFailure: false,

  isGettingCommentByCommentId: false,
  isGettingCommentByCommentIdSuccess: false,
  isGettingCommentByCommentIdFailure: false,

  isGettingAverageComment: false,
  isGettingAverageCommentSuccess: false,
  isGettingAverageCommentFailure: false,
