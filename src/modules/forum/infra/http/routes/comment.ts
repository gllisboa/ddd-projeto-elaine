...
import { getAverageCommentController } from '../../../useCases/comments/getAverageComment';
...
commentRouter.get('/average/:specificDate',
  middleware.includeDecodedTokenIfExists(),
(req, res) => {
  console.info('routes' )
  getAverageCommentController.execute(req, res)
}
);
